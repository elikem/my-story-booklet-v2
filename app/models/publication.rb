...
class Publication < ApplicationRecord
  ...
  def create_idml
    ...
    self.update(publication_status: "6_create_idml", publication_url: "#{ENV["CORE_APP_URL"]}/publications/#{self.id}/idml", publication_filename: publication_filename)
  ...
  def publish_idml_publication
    "#{ENV["COMPANION_APP_URL"]}/publish-idml-publication"
  end
